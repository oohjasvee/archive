...
export default function HeroSection() {
  ...
  return (
    <section id="hero" className="relative flex flex-col items-center justify-center min-h-[calc(100vh-4rem)] text-center px-4 py-20">
      ...
      <h1 className="text-5xl md:text-7xl font-black bg-clip-text text-transparent bg-gradient-to-b from-primary to-accent transition-all duration-500 hover:tracking-wider">
        {name}
      </h1>
